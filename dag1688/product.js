...
var numberSpan = number[1].getElementsByTagName("span");
var numberA = number[1].getElementsByTagName("a");

number[1].style.textAlign = "center";

numberSpan[0].style.display = "none";
numberSpan[1].innerHTML = "←上一页";
numberSpan[2].style.display = "none";

for(var num1=0;num1<numberA.length-2;num1++){
	numberA[num1].style.display = "none";
	numberA[8].innerHTML = "下一页→";
	numberA[9].style.display = "none";
}
